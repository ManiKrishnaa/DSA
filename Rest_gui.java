...
class Main
{
    ...
    void menu()
    {
        ...
        vegbtn.setBounds(300, 400, 100, 100);
        vegbtn.setBackground(Color.lightGray);

        nonvegbtn = new JButton("NON-VEG");
        nonvegbtn.setBounds(500, 400, 100, 100);
        nonvegbtn.setBackground(Color.lightGray);

        desserts = new JButton("DESSERTS & COOLDRINKS");
        desserts.setBounds(700, 400, 200, 100);
        desserts.setBackground(Color.lightGray);

        exit = new JButton("EXIT");
        exit.setBounds(1050, 400, 100, 100);
