...
class Main
{
    ...
    void menu()
    {
        ...
        JLabel bg = new JLabel(new ImageIcon("C:\\Users\\manik\\OneDrive\\Documents\\DSA\\project\\betchlogo.png")); 
        frame.add(bg);
        bg.setBounds(300, 0, 900, 300);
        frame.getContentPane().setBackground(Color.black);

        JLabel chefbg = new JLabel(new ImageIcon("C:\\Users\\manik\\OneDrive\\Documents\\DSA\\project\\chef.png")); 
        frame.add(chefbg);
        chefbg.setBounds(220, 60, 200, 200);

        JLabel info = new JLabel(" Mail : btechboyz@gmail.com  ,  Contact : 9876543210");
        info.setBounds(1200,750, 3000, 30);
        ...
        date.setBounds(1400, 200, 150, 20);
    ...
    void billing_menu()
    {
        ...
        JLabel chefimg = new JLabel(new ImageIcon("C:\\Users\\manik\\OneDrive\\Documents\\DSA\\project\\cropped-chef.png")); 
        chefimg.setBounds(400, 0, 100, 100);
        frame4.add(chefimg);

        JLabel name = new JLabel("B.TECH BOYZ");
        name.setBounds(500, 0, 300, 50);
        name.setFont(new Font("Arial", Font.BOLD, 40));
        name.setForeground(c);

        JLabel date_time = new JLabel("DATE & TIME : ");
        date_time.setBounds(650, 60, 100, 10);
        date_time.setForeground(c);
        frame4.add(date_time);
        ...
        dates.setBounds(750, 60, 150, 10);
        dates.setForeground(c);

        JLabel line1 = new JLabel("-----------------------------------------------------------------------------------------------------------------");
        line1.setBounds(400, 100, 600, 10);
